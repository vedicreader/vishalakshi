...
# %% auto #0
__all__ = ['VAULT_SP', 'MODELS', 'dflt_model', 'resolve_model', 'mk_prompt', 'cited']

# %% ../nbs/02_ask.ipynb #3caa518e
import os, re
from fastcore.all import AttrDict, L, patch
from .core import Vault, tidy_bc

# %% ../nbs/02_ask.ipynb #889a603c
