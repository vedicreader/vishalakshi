...
# %% auto #0
__all__ = ['KIND_OF', 'ACTIONS', 'IMG_EXTS', 'clip', 'records_md', 'secs', 'exif_meta', 'image_md']

# %% ../nbs/01_acquire.ipynb #6f849bdebde2
import hashlib, json, re, time, uuid, warnings
from urllib.parse import urlparse
from fastcore.all import AttrDict, L, Path, chunked, first, patch
from fossick import json_records, md_title, read, what_is, md_title, read, what_is, md_title, read, what_is
