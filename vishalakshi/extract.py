...
# %% auto #0
__all__ = ['TYPE_SP', 'DOCTYPE_SHELF', 'EXTRACT_SP', 'model_cached']

# %% ../nbs/06_extract.ipynb #4ecd1f8f2fc0
...
from rishi.core import Chat, infer_runtime, resp_text
from rahasya import NER_CHARS
from varga import (SIGNALS, DOCTYPES, KIND_HINT, MIN_SCORE, MIN_MARGIN, KIND_BONUS,
                   SCHEMAS, FIELD_TYPES, Invoice, Receipt, Catalogue, Contract, Resume, Paper,
                   MeetingNotes, Summary, signals, cue_scores, guess_type, dyn_schema, as_schema,
                   schema_str, structured)
from varga.core import _noun_ents
...
# %% ../nbs/06_extract.ipynb #2bea349c71db
...
# %% ../nbs/06_extract.ipynb #bee4cdd422ac
...
# %% ../nbs/06_extract.ipynb #72aef568b70a
@patch
